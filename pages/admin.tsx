...
import { subscribeToAllAnalytics, type AnalyticsData } from '../lib/analytics-firebase';
...
const Admin = () => {
  ...
  const [totals, setTotals] = useState<Totals>({ views: 0, shares: 0, comments: 0, loves: 0 });
