...
1.3 Press bearing (Item 3) onto shaft (Item 6) - Support inner race only - Press force: 2-3 kN maximum - Verify bearing seats against shoulder
...
1.4 Measure installed position with dial indicator - Runout: ≤ 0.02 mm TIR - Axial play: 0.01-0.03 mm
...
3.1 Increase pressure gradually - Rate: ≤ 50 psi per minute - Pause at 250 psi for 5 minutes (visual inspection) - Pause at 500 psi for 5 minutes (visual inspection) - Increase to 750 psi
