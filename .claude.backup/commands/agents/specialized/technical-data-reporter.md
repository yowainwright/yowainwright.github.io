...
✅ "Three actions to reduce costs by $18,700/month:
    1. Delete unused EBS ($3,200) - do this week
    2. Right-size RDS ($4,500) - needs testing
    3. Graviton migration ($8,900) - Q2 project"
```
...
### Source Attribution
```markdown
*Data source: Datadog APM, queried 2024-01-15*
*Time range: 2024-10-01 00:00 UTC to 2024-12-31 23:59 UTC*
*Methodology: [link to analysis notebook]*
```
