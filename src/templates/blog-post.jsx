    ...
    return (
      <article>
        <Helmet title={`${post.frontmatter.title} | Jeffry.in`}>
          ...
          <meta name="twitter:image" content={`${post.frontmatter.featured_image || 'https://yowainwright.imgix.net/w.jpg'}?w=1200&h=600&fit=crop&crop=focalpoint&auto=format`} itemProp="image" />
