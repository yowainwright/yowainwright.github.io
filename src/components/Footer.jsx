    ...
    <div className={`${name}__wrapper`}>
      <div className={`${name}__col`}>
        <p className={`${name}__body`}>
          ...
          —a software engineer, artist, runner, and surfer living in Los Angeles.{' '}
          <strong>
            <a href='mailto:yowainwright@gmail.com'>Email me</a>
          </strong>{' '}
          or reach out on{' '}
          <a href='https://github.com/yowainwright'>
            <strong>Github</strong>
          </a>
          ,{' '}
          <a href='https://instagram.com/yowainwright'>
            <strong>Instagram</strong>
          </a>
          ,{' '}
          <a href='https://twitter.com/yowainwright'>
            <strong>Twitter</strong>
          </a>
          ,{' '}
          <a href='https://www.strava.com/athletes/722335'>
            <strong>Strava</strong>
          </a>
          , or{' '}
          <a href='https://www.linkedin.com/in/jeffrywainwright/'>
