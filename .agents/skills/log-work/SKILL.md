---
name: log-work
description: Log completed work to an Obsidian daily note. Use when the user asks to log work, record today's progress, update an Obsidian daily note, summarize the session as a task entry, or capture commits/files changed.
---
