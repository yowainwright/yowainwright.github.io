...
function SocialPreview({
  ...
  const platformClass = platform === "twitter" ? "--twitter" : "";

  return (
    <div
      className={`og-preview__social-preview og-preview__social-preview${platformClass}`}
    >
      <img
        src={imageSrc}
      ...
      />
      <div className="og-preview__social-meta">
        <div
          className={`og-preview__social-site og-preview__social-site${platformClass}`}
        >
          jeffry.in
        </div>
        <div
          className={`og-preview__social-title og-preview__social-title${platformClass}`}
        >
          {post?.frontmatter?.title || "Blog Post"}
        </div>
        <div
          className={`og-preview__social-desc og-preview__social-desc${platformClass}`}
        >
