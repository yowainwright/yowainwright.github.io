...
date: "2026-01-21"
path: "/ai-token-gravy-train"
meta:
  "This post covers my AI token usage journey and what happened when limitless AI usage hit reality and becaome limited. I go into my evolution, how it happened, and what I am doing to fix the issue"
categories:
  - code
  - ai
  - claude
...
<figure>
    <img src="https://yowainwright.imgix.net/expensive-ai/claude-cost.png" alt="approximage cost of my work on claude per week" />
  <figcaption>This cost was my Claud Usage actual cost in October 2025</figcaption>
</figure>
...
This cost had felt abstract to me since we, engineers (for this posts context), all started using chat a few years ago.
I'd heard about affects on the environment and powergrind. However, it's a weird abstraction.
...
The graph per query **approximately** displays the real cost per each question you ask diffent models.
...
For this project, I spent time write my architectural plan, crafting agents to work together to assist in completing major pieces of the project.
...
## Flowchart example of the architectural agentic pattern I was following
...
This may read like low friction but this was just me. No team. Me and all of that stress deadline.
...
I'm also continually keep up with [crush](https://github.com/charmbracelet/crush), [ollama](https://ollama.com/), to try and insure I have some idea of what's going on!**
