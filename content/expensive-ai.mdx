...
date: "2026-01-21"
path: "/expensive-ai"
meta: "This post covers my AI token usage journey and what happened when limitless AI usage hit reality and became limited. I go into my evolution, how it happened, and what I am doing to fix the issue"
categories:
  - code
  - ai
  - claude
...
updating hooks, rules, and agents to handle more use cases.
Managing how I make Claude Code write code like me—or, even better, write code better than me—is something I feel it's worthwhile to spend time on.
...
<figure>
  <img
    src="https://yowainwright.imgix.net/expensive-ai/claude-cost.png"
    alt="approximate cost of my work on claude per week"
  />
  <figcaption>
    This cost was my Claude Usage actual cost in October 2025
  </figcaption>
</figure>
...
I'd heard about effects on the environment and power grid. However, it's a weird abstraction.
...
well, fair—_why put in the effort when my Max plan will be better?_ DHH is smart and so are the people that are building these models so, back to Claude.
...
> You may see where this is going. And, you may be thinking to yourself already, "If this guy can code, "What's the problem?".
...
My intended role was that of a foreman where I expected to take pieces of the project but major chunks of work went to different agents.

Since Claude Code came out, honing ways to instruct Claude to write code with my coding essence or in ways that most benefit my work has been my objective.
And for the last month, I have been honing an orchestrator agent flow where I've prompted a few superhero agents and they largely execute on tasks and I am a man in the middle overseeing the work.
It's cool! I mean, it IS cool if I can afford it.
...
As the messages became more persistent about my usage, I observed that I kept getting shifted to different models—or it felt like it.
I had my QA Lead agent working with my typescript expert agent getting code coverage up.
...
However, alongside providing proof easier, it is also far more important!
...
Anyway, it turned out my situation was worse than I had thought.
...
Although small, it was a tough problem. It was fun to ramp up on a large product with far less context than what I would have had pre-2022 but it was not where I wanted to be pre-product review.
...
And, I do appreciate the new craft. I do hope that as a human I get to participate in the fun parts of this tooling.
Currently, for this project, I felt like I was replacing a team, including all the stress of a team's deadline, leaving the fun UI and API mocks to Claude.
...
An article written by [Nicholas C. Zakas](https://humanwhocodes.com/blog/), code god creator of [eslint](https://eslint.org/) and inspirational person on multiple levels wrote [this post](https://newsletter.humanwhocodes.com/posts/expensive-ai-is-coming) which clearly illustrates the issue.
I'm also continually following [Crush](https://github.com/charmbracelet/crush), [ollama](https://ollama.com/), and [opencode](https://opencode.ai/) to try and ensure I have some idea of what's going on!
